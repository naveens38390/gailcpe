...
/** One role. The app has a single administrator account and nothing else. */
...
export class RoleDoc {
  ...
  /** Coarse capabilities. The administrator holds all of them. */
...
export class User {
  ...
  /** Locations this account covers; empty means national. */
  @Prop({ type: [String], default: [] })
  territories!: string[];
