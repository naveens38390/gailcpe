...
const useStyles = makeStyles((c) => ({
  ...
  count: { color: c.textFaint, fontSize: 11, marginTop: theme.space(2), marginBottom: theme.space(1) },
  listArea: { flex: 1 },
  row: {
    flexDirection: "row",
    alignItems: "center",
  ...
  checkboxMark: { color: c.onPrimary, fontSize: 13, fontWeight: "700" },
  empty: { color: c.textMuted, fontSize: 13, textAlign: "center", padding: theme.space(8) },
  ...
  drawerTitle: { color: c.textPrimary, fontSize: 16, fontWeight: "800" },
  drawerClose: { color: c.primary, fontSize: 14, fontWeight: "700" },
  ...
  selectionCount: { color: c.textPrimary, fontSize: 13, fontWeight: "700" },
  selectionActions: { flexDirection: "row", alignItems: "center", gap: theme.space(4) },
  selectionClear: { color: c.danger, fontSize: 12, fontWeight: "700" },
}));
