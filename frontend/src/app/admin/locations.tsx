...
import { api, type LocationHit, type Revision } from "../../services/api";
...
const useStyles = makeStyles((c) => ({
  ...
  rowMeta: { color: c.textMuted, fontSize: 12, marginTop: theme.space(2), marginBottom: theme.space(1) },
  rowFaint: { color: c.textFaint, fontSize: 10 },
  zoneRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: theme.space(2),
  ...
  zoneProducer: { color: c.textMuted, fontSize: 12, fontWeight: "700", width: 56 },
  zoneValue: { color: c.textPrimary, fontSize: 12, flex: 1 },
