            ...
            >
              <View style={styles.hitHead}>
                ...
                {hit.confidence && hit.confidence !== "H" ? (
                  <Pill label={`CONF ${hit.confidence}`} color={colors.warning} />
                ) : null}
              </View>
...
const useStyles = makeStyles((c) => ({
  ...
  hitGrade: { color: c.textPrimary, fontSize: 15, fontWeight: "700" },
  hitMeta: { color: c.textMuted, fontSize: 12, marginTop: 2 },
  hitVia: { color: c.textFaint, fontSize: 11, marginTop: 2 },
  detailHead: {
    flexDirection: "row",
    justifyContent: "space-between",
    alignItems: "center",
  },
  detailGrade: { color: c.textPrimary, fontSize: 22, fontWeight: "800" },
  back: { color: c.primary, fontSize: 13, fontWeight: "600" },
  detailMeta: { color: c.textMuted, fontSize: 13, marginTop: 2 },
  specs: { flexDirection: "row", gap: theme.space(6), marginTop: theme.space(3) },
  spec: {},
  specLabel: { color: c.textFaint, fontSize: 10 },
  specValue: { color: c.textPrimary, fontSize: 13, fontWeight: "600" },
  equivRow: {
    flexDirection: "row",
  ...
  codeText: { color: c.textPrimary, fontSize: 12, fontWeight: "600" },
  codeTextStale: { textDecorationLine: "line-through" },
  none: { color: c.textFaint, fontSize: 12, fontStyle: "italic" },
  footnote: {
    color: c.textFaint,
    fontSize: 11,
    lineHeight: 16,
  ...
  international: { color: c.textMuted, fontSize: 12, lineHeight: 20 },
}));
