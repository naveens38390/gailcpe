...
import { api, type ProducerRecord, type Revision } from "../../../lib/api";
          ...
          <View key={p.code} style={styles.row}>
            <View style={styles.rowHead}>
              ...
              <Pill
                ...
                color={p.active ? theme.color.leading : theme.color.behind}
              />
            </View>
...
const styles = StyleSheet.create({
  ...
  switchLabel: { color: theme.color.textMuted, fontSize: 13 },
});
