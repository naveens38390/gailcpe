...
const styles = StyleSheet.create({
  ...
  readOnlyNote: { color: theme.color.textFaint, fontSize: 11, marginTop: theme.space(2) },
  summaryRow: { flexDirection: "row", justifyContent: "space-between", paddingVertical: 3 },
  summaryLabel: { color: theme.color.textMuted, fontSize: 12 },
  summaryValue: { color: theme.color.text, fontSize: 12, fontWeight: "700" },
  slabTable: { marginTop: theme.space(1) },
  slabRow: { color: theme.color.textFaint, fontSize: 11, paddingVertical: 1 },
  impact: {
  ...
  removeSlab: { color: theme.color.behind, fontSize: 16, paddingHorizontal: theme.space(1) },
  addSlab: { alignSelf: "flex-start", marginTop: theme.space(1) },
  addSlabText: { color: theme.color.accent, fontSize: 12, fontWeight: "700" },
});
