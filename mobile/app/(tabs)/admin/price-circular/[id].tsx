...
import { STATUS_COLOR } from "../../../../lib/masterData";
import { rupees, theme } from "../../../../lib/theme";
import { Card, ErrorNote, ExportButtons, Loading, Pill } from "../../../../lib/ui";
    ...
    <View style={styles.root}>
      ...
      <View style={styles.header}>
        <View style={styles.headerRow}>
          ...
          <Pill label={draft.status.toUpperCase()} color={STATUS_COLOR[draft.status] ?? theme.color.unknown} />
        </View>
      ...
      <DataGrid
        ...
        renderBadge={(r) => (
          <View style={styles.badgeArea}>
            {r.changed ? <Pill label="CHANGED" color={theme.color.matched} /> : null}
...
const styles = StyleSheet.create({
  ...
  subtitle: { color: theme.color.textFaint, fontSize: 12, marginTop: 2 },
  ...
  rejectLink: { color: theme.color.behind, fontSize: 12, fontWeight: "700" },
  diffTitle: { color: theme.color.textMuted, fontSize: 11, fontWeight: "700", marginBottom: theme.space(2) },
  diffRow: { paddingVertical: 3, flexDirection: "row", justifyContent: "space-between" },
  diffField: { color: theme.color.text, fontSize: 12, fontWeight: "700" },
  diffValues: { color: theme.color.textMuted, fontSize: 12 },
  diffMore: { color: theme.color.textFaint, fontSize: 11, marginTop: theme.space(1) },
