...
import { api, type GradeDetail, type GradeHit, type GradeImpact, type Revision } from "../../../lib/api";
...
const STATUS_PILL: Record<string, string> = {
  active: theme.color.leading,
  deprecated: theme.color.matched,
  retired: theme.color.behind,
};
        ...
        <Card>
          <View style={styles.cardHead}>
            <View style={styles.titleRow}>
              ...
              {selected.status ? (
                <Pill label={selected.status.toUpperCase()} color={STATUS_PILL[selected.status]} />
              ) : null}
            </View>
...
const styles = StyleSheet.create({
  ...
  rowMeta: { color: theme.color.textMuted, fontSize: 12, marginTop: theme.space(1) },
  equivRow: {
    flexDirection: "row",
    alignItems: "center",
    gap: theme.space(2),
  ...
  equivProducer: { color: theme.color.textMuted, fontSize: 12, fontWeight: "700", width: 56 },
  equivCodes: { color: theme.color.text, fontSize: 12, flex: 1 },
  ...
  impactTitle: { color: theme.color.textFaint, fontSize: 10, fontWeight: "700", textTransform: "uppercase" },
  impactLine: { color: theme.color.text, fontSize: 13, marginTop: theme.space(1) },
  impactWarn: { color: theme.color.matched, fontSize: 12, marginTop: theme.space(1) },
